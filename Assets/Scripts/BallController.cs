...
public class BallController : MonoBehaviour
{
    ...
    void ResetPaddle() {
        paddle1 = GameObject.Find("Pemukul1");
        paddle2 = GameObject.Find("Pemukul2");

        paddle1.transform.position = new Vector3(-7.5f,0,0);
        paddle2.transform.position = new Vector3(7.5f,0,0);
    }
